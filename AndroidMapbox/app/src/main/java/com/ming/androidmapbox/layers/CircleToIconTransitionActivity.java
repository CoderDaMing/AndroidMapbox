...
public class CircleToIconTransitionActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(final MapboxMap mapboxMap) {
        mapboxMap.setStyle(new Style.Builder().fromUri(Style.LIGHT)
                        ...
                        .withImage(ICON_IMAGE_ID, getResources().getDrawable(R.drawable.atm_symbol_icon))
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        Toast.makeText(CircleToIconTransitionActivity.this, "缩放地图查看效果", Toast.LENGTH_SHORT).show();
